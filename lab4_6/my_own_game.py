...
Hey are you allright, do you find an amulate?', 'A tall, handsome guy. He was a computer scince student\n\
...
while energy > 0 and find_amulet == False:
    ...
    command = input('\nPlease chose yout action("take", "eat", "talk"\
or write place to go from the list)\n>>> ')
